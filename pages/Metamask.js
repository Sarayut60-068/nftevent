...
class Metamask extends Component {
  ...
  async connectToMetamask() {
    ...
    const daiContract = new ethers.Contract('0x5e223419084f5F89d14e61e6E7022f605dcA57a0', ERC721_ABI, provider);
  ...
  async sendDaiTo(to, amountInEther) {
    ...
    daiContractWithSigner.transfer("0xFB18608623114238054aA208ebb8961d27023048", tokenAmountInEther);
  }
    ...
    if (!this.state.selectedAddress) {
      ...
      return (
        <div>
          ...
          <button onClick={() => this.sendDaiTo("0xFB18608623114238054aA208ebb8961d27023048", "1")}>Donate 1 DAI</button>
        </div>
      );
    }
  }
